// This file randomly generates a bunch of different sized media elements.
// Note that there are two sets...the first class="row-grid" will all have the same height. 
// The second class="col-grid" should all have the same width.
